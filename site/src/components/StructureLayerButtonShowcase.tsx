...
const sections: readonly SectionBlock[] = [
  {
    ...
    circleX: 146,
    circleY: 1013,
    image: 'pencil/xingji-aodaisai/common-buttons-transparent.webp',
    imageAlt: '常规按钮样式',
    imageX: 133,
    imageY: 1056,
    imageWidth: 160,
  ...
  },
  {
    ...
    circleX: 811,
    circleY: 1013,
    image: 'pencil/xingji-aodaisai/special-buttons-transparent.webp',
    imageAlt: '特殊按钮样式',
    imageX: 798,
    imageY: 1047,
    imageWidth: 187,
  ...
  },
  {
    ...
    circleX: 146,
    circleY: 1562,
    image: 'pencil/xingji-aodaisai/tab-buttons-transparent.webp',
    imageAlt: '页签按钮样式',
    imageX: 133,
    imageY: 1605,
    imageWidth: 294,
  ...
  },
  {
    ...
    circleX: 803,
    circleY: 1562,
    image: 'pencil/xingji-aodaisai/switch-buttons-updated-transparent.webp',
    imageAlt: '开关按钮样式',
    imageX: 790,
    imageY: 1605,
    imageWidth: 178,
  ...
  return (
    <figure className="project-detail-inner-card mx-auto w-full max-w-[1360px] overflow-hidden rounded-[24px] border border-neon-cyan/25 bg-[#0b1320]/55 2xl:max-w-[1480px]">
      ...
      >
        ...
        <image
          href={publicUrl('pencil/xingji-aodaisai/basic-controls-panel.webp')}
          x={498}
          y={235}
          width={300}
          height={650}
