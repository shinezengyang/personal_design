...
const caseOneAssets = {
  cpaLastwarTop: publicUrl('images/xingji/hud/assets/cpa-lastwar.webp'),
  cpaLastwarBottom: publicUrl('images/xingji/hud/assets/cpa-lastwar.webp'),
  cpaWinter: [
    publicUrl('images/xingji/hud/assets/cpa-winter.webp'),
    publicUrl('images/xingji/hud/assets/cpa-winter.webp'),
  ],
  cpaAfk: [
    publicUrl('images/xingji/hud/assets/cpa-afk.webp'),
    publicUrl('images/xingji/hud/assets/cpa-afk.webp'),
    publicUrl('images/xingji/hud/assets/cpa-afk.webp'),
    publicUrl('images/xingji/hud/assets/cpa-afk.webp'),
  ],
  cpaBrave: [
    publicUrl('images/xingji/hud/assets/cpa-brave.webp'),
    publicUrl('images/xingji/hud/assets/cpa-brave.webp'),
  ],
  cpaHeroes: [
    publicUrl('images/xingji/hud/assets/cpa-heroes.webp'),
    publicUrl('images/xingji/hud/assets/cpa-heroes.webp'),
    publicUrl('images/xingji/hud/assets/cpa-heroes.webp'),
    publicUrl('images/xingji/hud/assets/cpa-heroes.webp'),
  ],
  cpaDao: publicUrl('images/xingji/hud/assets/cpa-dao.webp'),
  cpaCapy: [
    publicUrl('images/xingji/hud/assets/cpa-capy.webp'),
    publicUrl('images/xingji/hud/assets/cpa-capy.webp'),
    publicUrl('images/xingji/hud/assets/cpa-capy.webp'),
    publicUrl('images/xingji/hud/assets/cpa-capy.webp'),
    publicUrl('images/xingji/hud/assets/cpa-capy.webp'),
